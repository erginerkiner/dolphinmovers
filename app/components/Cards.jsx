...
export default function Cards(){
    return(
        ...
        <div className="bg-gradient-to-l from-[#01096E] to-[#000000] grid justify-center w-full h-72 md:w-full rounded-xl py-4 px-2 mb-4">
            ...
            <p className="text-white font-normal text-sm text-center">We ofter a convenient menu of standart freight management services to balance urgency 
        ...
        <div className="bg-gradient-to-l from-[#000000] to-[#01096E] grid justify-center w-full h-72 md:w-full rounded-xl py-4 px-2 mb-4">
            ...
            <p className="text-white font-normal text-sm text-center">As a full- service logistics company, we leverage on our wide network of 
        ...
        <div className="bg-gradient-to-l from-[#01096E] to-[#000000] grid justify-center w-full h-72 md:w-full rounded-xl py-4 px-2">
            ...
            <p className="text-white font-normal text-sm text-center">Improving the daily lives and businesses of our customers is at 
